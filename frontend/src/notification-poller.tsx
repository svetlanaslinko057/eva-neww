    ...
    const tick = async () => {
      ...
      try {
        ...
        for (const n of items) {
          ...
          const subtitle = typeof n.subtitle === 'string' ? n.subtitle.trim() : '';
          // Skip empty/silent notifications — still mark them as read above
          // so they don't keep popping on every poll.
