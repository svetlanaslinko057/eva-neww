      ...
      {items.slice(0, 3).map((d) => (
        ...
        >
          <View style={{ flex: 1, marginRight: 10 }}>
            <Text style={s.rowTitle} numberOfLines={2}>{d.title}</Text>
...
const s = StyleSheet.create({
  ...
  rowTitle: { color: T.text, fontSize: T.small, fontWeight: '700', lineHeight: 18 },
  ...
  ctaText: { color: T.bg, fontSize: T.tiny, fontWeight: '800' },
