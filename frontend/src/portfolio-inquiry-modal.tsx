...
const s = StyleSheet.create({
  ...
  inputMultiline: { minHeight: 110, paddingTop: 12, paddingBottom: 12, textAlignVertical: 'top' },
  ...
  primaryBtnText: { color: T.primaryInk, fontSize: 14, fontWeight: '700', textAlign: 'center', flexShrink: 1 },
  secondaryBtn: {
    backgroundColor: T.surface,
    borderColor: T.border,
    borderWidth: 1,
  ...
  secondaryBtnText: { color: T.text, fontSize: 14, fontWeight: '600', textAlign: 'center', flexShrink: 1 },
