    ...
    <SafeAreaView style={s.flex} edges={['bottom']}>
      ...
      <View style={s.tabs}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Ionicons name="book-outline" size={14} color={tab === 'faq' ? T.primary : T.textMuted} />
          <Text
            style={[s.tabText, tab === 'faq' && s.tabTextActive]}
            numberOfLines={1}
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Ionicons name="ticket-outline" size={14} color={tab === 'tickets' ? T.primary : T.textMuted} />
          <Text
            style={[s.tabText, tab === 'tickets' && s.tabTextActive]}
            numberOfLines={1}
            adjustsFontSizeToFit
            minimumFontScale={0.75}
          >
