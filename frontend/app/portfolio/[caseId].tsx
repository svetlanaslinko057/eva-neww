      ...
      <ScrollView contentContainerStyle={s.scroll} testID="portfolio-detail-screen">
        ...
        <View style={s.upsellBlock}>
          ...
          <Text style={s.upsellHeadline}>
            {data.cta_headline || 'Want a similar project?'}
          </Text>
          {data.starting_from ? (
          ...
          <View style={s.ctaRow}>
            ...
            >
              ...
              <Text style={s.ctaSecondaryText}>Calculate</Text>
            </Pressable>
          </View>
...
const s = StyleSheet.create({
  ...
  ctaSecondaryText: { color: T.text, fontSize: 11, fontWeight: '700', lineHeight: 14 },
