    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      >
        ...
        {/* ─── Decision panel ─── Mirrors web ClientDeliverablePage redesign.
            Stacks vertically on narrow mobile screens so long translations
            (UK/RU) never collapse into 1-char-wide columns. */}
        {isPendingApproval && (
          <View style={s.decisionBlock} testID="deliverable-actions">
            ...
            <View style={s.decisionHeader}>
              ...
              <View style={s.decisionHeaderBody}>
                <Text style={s.decisionTitle} numberOfLines={2}>
                  Your decision
                </Text>
                <Text style={s.decisionSubtitle} numberOfLines={2}>
                  Awaiting your review.
                </Text>
              </View>
              <View style={s.pendingPill}>
                <Ionicons name="time-outline" size={10} color={T.warning} />
                <Text style={s.pendingPillText} numberOfLines={1}>Pending</Text>
              </View>
            </View>

            {/* Outcome explainer — stacked, full width each */}
            <View style={s.outcomeStack}>
              <View style={s.outcomeRowStacked}>
              ...
              <View style={s.outcomeRowStacked}>
                <View style={s.outcomeHeader}>
                  ...
                  <Text style={s.outcomeLabel} numberOfLines={1}>Request changes</Text>
                </View>
                <Text style={s.outcomeDesc}>
            ...
            <View style={s.actionsRow}>
              ...
              >
                ...
                <Text style={s.actionBtnPrimaryText} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.8}>
                  Approve delivery
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                ...
                <Text style={s.actionBtnGhostText} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.8}>
                  Request changes
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={s.helpRow}>
              ...
              <Text style={s.helpText} numberOfLines={2}>
...
const s = StyleSheet.create({
  ...
  // ─── Decision panel (redesigned · stacked) ───
  ...
  decisionHeaderIcon: { width: 30, height: 30, borderRadius: 9, alignItems: 'center', justifyContent: 'center', backgroundColor: T.successTint, borderWidth: 1, borderColor: T.successBorder, flexShrink: 0 },
  decisionHeaderBody: { flex: 1, minWidth: 0 },
  decisionTitle: { color: T.text, fontWeight: '700', fontSize: 14 },
  decisionSubtitle: { color: T.textMuted, fontSize: 11, marginTop: 1 },
  pendingPill: { flexDirection: 'row', alignItems: 'center', gap: 3, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 999, backgroundColor: T.warningTint, borderWidth: 1, borderColor: T.warningBorder, flexShrink: 0 },
  pendingPillText: { color: T.warning, fontSize: 9, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.4 },

  outcomeStack: { paddingHorizontal: 14, paddingVertical: 10 },
  outcomeRowStacked: { paddingVertical: 10 },
  outcomeHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 6 },
  outcomeIcon: { width: 22, height: 22, borderRadius: 6, alignItems: 'center', justifyContent: 'center', borderWidth: 1, flexShrink: 0 },
  outcomeLabel: { color: T.text, fontWeight: '700', fontSize: 13, flex: 1 },
  outcomeDesc: { color: T.textMuted, fontSize: 12, lineHeight: 17, paddingLeft: 30 },
  outcomeDivider: { height: 1, backgroundColor: T.border, marginVertical: 2 },
  ...
  actionsRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 14, paddingVertical: 12, borderTopWidth: 1, borderColor: T.border, flexWrap: 'wrap' },
  actionBtn: { flex: 1, flexBasis: '48%', minWidth: 130, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingVertical: 12, paddingHorizontal: 8, borderRadius: 12 },
  actionBtnPrimary: { backgroundColor: T.primary },
  actionBtnPrimaryText: { color: T.primaryInk, fontWeight: '700', fontSize: 13, flexShrink: 1, textAlign: 'center' },
  actionBtnGhost: { borderWidth: 1, borderColor: T.borderStrong, backgroundColor: 'transparent' },
  actionBtnGhostText: { color: T.text, fontWeight: '700', fontSize: 13, flexShrink: 1, textAlign: 'center' },

  helpRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingHorizontal: 14, paddingVertical: 9, borderTopWidth: 1, borderColor: T.border },
  helpText: { color: T.textMuted, fontSize: 11, flexShrink: 1 },
