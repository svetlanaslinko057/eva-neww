      ...
      <ScrollView contentContainerStyle={s.container} testID="client-profile">
        ...
        {hasTour ? (
          <MenuRow
            ...
            onPress={() => {
              // Tour targets live on Home, not Profile. Navigate first, then
              // kick off the tour after the layout has had a moment to mount
              // so the tooltip can anchor to the correct elements.
              router.push('/client/home' as any);
              setTimeout(() => { void replayTour(); }, 350);
            }}
