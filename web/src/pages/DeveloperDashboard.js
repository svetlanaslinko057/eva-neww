    ...
    <div data-testid="developer-dashboard">
      <div className="max-w-7xl mx-auto w-full space-y-6">
        ...
        <Card className="border-2 border-[color:var(--success-border)] bg-card shadow-[var(--shadow-elev-1)]" data-testid="money-block">
          ...
          <CardContent>
            <div
              className="grid md:grid-cols-3 gap-2 md:gap-6"
              style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))' }}
            >
              <div className="space-y-1">
                <p className="text-[10px] md:text-sm text-muted-foreground font-medium uppercase tracking-wide leading-tight">{tByEn('This Week')}</p>
                <p className="text-xl md:text-4xl font-bold font-mono text-[color:var(--success)] leading-none" data-testid="earnings-week">
                  ${data.earnings.this_week}
                </p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] md:text-sm text-muted-foreground font-medium uppercase tracking-wide leading-tight">{tByEn('This Month')}</p>
                <p className="text-xl md:text-4xl font-bold font-mono text-[color:var(--success)] leading-none" data-testid="earnings-month">
                  ${data.earnings.this_month}
                </p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] md:text-sm text-muted-foreground font-medium uppercase tracking-wide leading-tight">{tByEn('Avg per Module')}</p>
                <p className="text-xl md:text-4xl font-bold font-mono text-foreground leading-none" data-testid="earnings-avg">
