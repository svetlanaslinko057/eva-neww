...
const SequenceSection = () => { const { tByEn } = useLang(); return (
  <section
    id="sequence"
...
const SystemSection = () => { const { t, tByEn } = useLang(); const { openContact } = useContactModal(); return (
  <section
    id="system"
  ...
  >
    <div style={{ maxWidth: 1240, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: 44 }}>
        <HeavyButton onClick={() => openContact({ source: 'system-core' })} testid="system-lead-cta" size="md">
          {t('lead.cta')}
...
const UseCasesSection = () => { const { tByEn } = useLang(); return (
  <section
    id="use-cases"
...
const UseCasesFooter = () => {
  ...
  return (
    <a
      ...
      onClick={(e) => { e.preventDefault(); openContact({ source: 'use-cases' }); }}
      onMouseEnter={() => setHover(true)}
      onMouseLeave={() => setHover(false)}
      style={{
        display: 'grid',
