...
const ClientProjects = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6" data-testid="client-projects">
      ...
      {/* Search & Filters */}
      <div className="flex flex-wrap gap-4 mb-6 keep-row-mobile m-cabinet-filter-bar">
        <div className="flex-1 min-w-[200px] relative">
          ...
          <input
            ...
            className="m-search-input w-full bg-[var(--t-surface-raised)] border border-border rounded-xl pl-12 pr-4 py-3 text-white placeholder:text-muted-foreground focus:outline-none focus:border-signal/50"
          />
        </div>
        
        {/* Filter Tabs — wraps to its own line on mobile and becomes a horizontal-scroll chip row */}
        <div className="m-chip-row keep-row-mobile flex bg-[var(--t-surface-raised)] border border-border rounded-xl p-1">
          {[
            { key: 'all',       enLabel: 'All' },
  ...
  return (
    <div className="relative" onMouseDown={(e) => e.stopPropagation()}>
      ...
      {open && (
        <ul
          role="listbox"
          className="absolute left-0 sm:left-auto sm:right-0 mt-2 w-[200px] max-w-[calc(100vw-32px)] rounded-xl border border-border bg-card shadow-lg overflow-hidden z-50"
